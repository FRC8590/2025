...
/** Removes top algae and scores L3. */
public class AutoLeftTopRemoveAlgae extends SequentialCommandGroup {

  // Define the AprilTag IDs we're interested in
  
  /**
   * Removes top algae and scores L3.
   * Calls RemoveTopAlgaeScoreTop()
   * then ScoreCoral()
   */
  public AutoLeftTopRemoveAlgae() {
