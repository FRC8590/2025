...
public class UniversalRightBot extends SequentialCommandGroup {
  ...
  private Pose2d getRightScoringPosition(int tagId) {
    return ScoringPositionTransformer.transformScoringPosition(
        ...
        tagId,                 // Target tag ID
        false                  // Target is right position
    );
  }
  ...
  private final Command moveToScore =
      new SelectCommand<>(
          ...
          Map.ofEntries(
              Map.entry(17, Constants.drivebase.driveToPose(getRightScoringPosition(17))),
              Map.entry(18, Constants.drivebase.driveToPose(getRightScoringPosition(18))),
              Map.entry(19, Constants.drivebase.driveToPose(getRightScoringPosition(19))),
              Map.entry(20, Constants.drivebase.driveToPose(getRightScoringPosition(20))),
              Map.entry(21, Constants.drivebase.driveToPose(getRightScoringPosition(21))),
              Map.entry(22, Constants.drivebase.driveToPose(getRightScoringPosition(22))),
              Map.entry(6, Constants.drivebase.driveToPose(getRightScoringPosition(6))),
              Map.entry(7, Constants.drivebase.driveToPose(getRightScoringPosition(7))),
              Map.entry(8, Constants.drivebase.driveToPose(getRightScoringPosition(8))),
              Map.entry(9, Constants.drivebase.driveToPose(getRightScoringPosition(9))),
              Map.entry(10, Constants.drivebase.driveToPose(getRightScoringPosition(10))),
              Map.entry(11, Constants.drivebase.driveToPose(getRightScoringPosition(11)))),
          this::getClosestTag);
}