...
public class ScoreDrive extends SequentialCommandGroup {
  ...
  ScoreDrive() {
    addCommands(
        ...
        // Constants.drivebase.driveToDistanceCommand(Units.feetToMeters(2.56), 0.8),
              Constants.drivebase.driveToPose(new Pose2d(getApriltagTranslation2d(20), getApriltagRotation2d(20))),
  ...
  public Rotation2d getApriltagRotation2d(int apriltag)
  {
    if(apriltag == 17){
  ...
  public Translation2d getApriltagTranslation2d(int apriltag)
  {
    ...
    if(apriltag == 19){
      return new Translation2d(3.648, 5.556);
    }
    if(apriltag == 20){
      return new Translation2d(5.353, 5.556);
    }
    if(apriltag == 21){
